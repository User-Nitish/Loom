...
![UI-community](https://raw.githubusercontent.com/nz-m/Loom/main/resources/UI-community.png)
...
![Schema Diagram](https://raw.githubusercontent.com/nz-m/Loom/main/resources/Schema-Diagram.png)
...
```bash
git clone https://github.com/nz-m/Loom.git
```
...
Moderators have specific email domain (`@mod.loom.com`). When registering with an email from this domain, the user is automatically assigned the moderator role. Moderators can be assigned to different communities from the admin dashboard.
...
This project is licensed under the [MIT License](https://github.com/nz-m/Loom/blob/main/LICENSE).
