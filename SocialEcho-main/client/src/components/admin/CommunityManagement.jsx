      ...
      <div className="flex flex-col w-full lg:w-2/3 glass-card !bg-black/60 border border-white/5 shadow-2xl p-8 relative overflow-hidden group">
        ...
        {isChangingCommunity ? (
          <div className="flex flex-col items-center justify-center h-full gap-4">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.4em] text-v-cyan italic animate-pulse">Syncing_Sector_Data</span>
          </div>
              ...
              <div className="space-y-2 flex-1">
                ...
                <div className="flex flex-wrap gap-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-v-yellow text-[10px] font-black uppercase tracking-widest bg-v-yellow/10 px-2 py-1 rounded">Nodes: {selectedCommunityData.memberCount}</span>
                  </div>
                </div>
              </div>
              {isUpdating && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-xs font-black uppercase tracking-[0.3em] text-white/50">Active_Operators</h2>
                </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-xs font-black uppercase tracking-[0.3em] text-white/50">Assign_New_Priority</h2>
                </div>
          ...
          <div className="flex flex-col items-center justify-center h-full text-center p-20">
            ...
            <p className="text-[10px] text-white/10 font-black uppercase tracking-widest mt-4 max-w-xs">
              Select a sector from the directory to begin terminal command sequence.
            </p>
          </div>
        )}
      </div>
